...
const AddBookForm = () => {
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <input placeholder="Cím" value={title} onChange={(e) => setTitle(e.target.value)} />
      <input placeholder="Szerző" value={author} onChange={(e) => setAuthor(e.target.value)} />
      <input placeholder="Év" value={year} onChange={(e) => setYear(e.target.value)} />
      <input placeholder="Műfaj" value={genre} onChange={(e) => setGenre(e.target.value)} />
      <input placeholder="Oldalszám" value={pages} onChange={(e) => setPages(e.target.value)} />
